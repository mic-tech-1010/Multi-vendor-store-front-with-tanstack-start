            ...
            <form id="search-form" className="flex h-10 w-full rounded-sm" role="search">
                ...
                <div className="h-full">
                    ...
                    <Select name="">
                        <SelectTrigger
                            id="search-category"
                            className="bg-[#e6e6e6] text-[#555] p-1.5 max-w-max rounded-tr-none rounded-br-none rounded-l-sm h-full! focus:outline-solid! focus:outline-offset-3! focus:outline-white! focus:outline-1"
                        >
                ...
                <Input
                    type="search"
                    id="search-input"
                    className="outline-none! rounded-none bg-white h-full text-base!"
                ...
                <Button
                    type="submit"
                    aria-label="search"
                    className="text-[#333] focus:outline-solid! focus:outline-offset-1! focus:outline-white! focus:outline-1 cursor-pointer h-full p-2 bg-[hsl(34,88%,62%)] hover:bg-[hsl(34,88%,62%)] rounded-l-none rounded-r-sm"
                >
