        ...
        return (
            <Dialog open={open} onOpenChange={setOpen}>
                <DialogTrigger asChild>
                    <Button variant="default" className='flex items-end gap-0.5 cursor-pointer max-tablet:flex-auto max-tablet:order-3 max-tablet:min-w-full'>
    ...
    return (
        <Drawer open={open} onOpenChange={setOpen}>
            <DrawerTrigger asChild>
                <Button variant="default" className='flex items-end gap-0.5 cursor-pointer max-tablet:flex-auto max-tablet:order-3 max-tablet:justify-start'>
